...
export const Cart = ({ProductImage, ProductName, ProductCurrency, ProductDiscounterPrice, Display})=>{
    ...
    const handleAddQuantity = () => {
        quantity===5 ?  SetQunatity(5) : SetQunatity(quantity + 1)
    }

    const handleSubQuantity = () => {
        quantity===1 ?  SetQunatity(1) : SetQunatity(quantity - 1)
    }
    const handleNoItem = () => {
        setNoItem(!noItem);
    }
                ...
                <div className="cart-content">
                    <div className="cart-title">
                        <div className="close-cart-container">
                            <svg 
                                className="close close-cart-btn" 
                                id="Close-Cart__btn" 
                    ...
                    {(!noItem && !Display) &&
                        <div className='no-item-container'>
                            ...
                            <Link href="/store">Master Isolation Store</Link>
                        </div>
                    }
                    {Display &&
                    <div className="products-cart-list">
                        <div className="product-cart-container">
                            <div className='product-image-name-container'>
                                ...
                                <div>
                                    <h1>{ProductName}</h1>
                                    <div>
                                        <span className='input-value'>${quantity}</span><span className='value-x'>x    </span>
                            ...
                            <div className='value-info-container'>
                                <div className='product-value-container'>
                                    <button className='minus-btn' onClick={handleSubQuantity}>-</button>
                                    <input type="text" defaultValue={1} value={quantity} readOnly />
                                    <button className='plus-btn' onClick={handleAddQuantity}>+</button>
                                </div>
                        ...
                        <div>
                            <div className="sub-total-container">
                                <h1>Sub Total:</h1>
                                <div className="sub-total-price-container">

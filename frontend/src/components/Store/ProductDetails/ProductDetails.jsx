...
export const ProductDetails = () =>{
    ...
    const handlePrice = ()=>{
        ...
        document.getElementById('discountedPrice').textContent = productDiscountedPrice * Quantity;
        document.getElementById('regularPrice').textContent = productRegularPrice * Quantity;
    }
            ...
            <div className='ProductDetails'>
                <div className='Product-Name-Options__container'>
                    ...
                    <div className='Product-Options__container'>
                        <button onClick={handleGeneralInfo} className='active'>General info</button>
                        <button onClick={handleProductDetails}>Product details</button>
                        <button onClick={handleReviews}>Reviews<sup>12</sup></button>
                    </div>
                    <hr/>
                </div>
                    ...
                    <div className="Product-Info right-side">
                        {GenInfo && 
                            <div className='GenInfo'>
                                <div className="space-between__container">
                                    <div className="Product-Price__container">
                                        <span className='Product__Discounted-Price'>
                                            <span className='Quantity' id='qunatity-price'>1x</span><span>{productDiscountedPrice} = </span>
                                        ...
                                        <button className='Product__Discount-Percentage'>-50%</button>
                                    </div>
                                ...
                                <div className='flex__container Product-Options_container'>
                                    {/* Select Input */}
                                    <div className="Main-Size-Select__container">
                                        ...
                                        <div className='Size-Select__container'>
                                            <select>
                                                <option value="" key="" disabled selected>Please select</option>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" min={1} max={5} defaultValue={1} onChange={handlePrice} id='quantity'/>
                                    </div>
                                </div>
                                ...
                                <div className='Product-read-more__container'>
                                    <ReadMore Title='Delivery' Content='Im a shipping policy. Im a great place to add more information'/>
                                    <ReadMore Title='Return' Content='Im a shipping policy. Im a great place to add more information'/>
                                    <ReadMore Title='More Info' Content='Im a shipping policy. Im a great place to add more information'/>
                                </div>
                                <div>
                                    <div className='flex__container Share__container'>
                                        <span>Share:</span>
                                        <div className='Share-Social-Media__container'>
                                            <svg title='Facebook' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12.001 2C6.47813 2 2.00098 6.47715 2.00098 12C2.00098 16.9913 5.65783 21.1283 10.4385 21.8785V14.8906H7.89941V12H10.4385V9.79688C10.4385 7.29063 11.9314 5.90625 14.2156 5.90625C15.3097 5.90625 16.4541 6.10156 16.4541 6.10156V8.5625H15.1931C13.9509 8.5625 13.5635 9.33334 13.5635 10.1242V12H16.3369L15.8936 14.8906H13.5635V21.8785C18.3441 21.1283 22.001 16.9913 22.001 12C22.001 6.47715 17.5238 2 12.001 2Z"></path></svg>
                                            <svg title='Twitter' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M22.2125 5.65605C21.4491 5.99375 20.6395 6.21555 19.8106 6.31411C20.6839 5.79132 21.3374 4.9689 21.6493 4.00005C20.8287 4.48761 19.9305 4.83077 18.9938 5.01461C18.2031 4.17106 17.098 3.69303 15.9418 3.69434C13.6326 3.69434 11.7597 5.56661 11.7597 7.87683C11.7597 8.20458 11.7973 8.52242 11.8676 8.82909C8.39047 8.65404 5.31007 6.99005 3.24678 4.45941C2.87529 5.09767 2.68005 5.82318 2.68104 6.56167C2.68104 8.01259 3.4196 9.29324 4.54149 10.043C3.87737 10.022 3.22788 9.84264 2.64718 9.51973C2.64654 9.5373 2.64654 9.55487 2.64654 9.57148C2.64654 11.5984 4.08819 13.2892 6.00199 13.6731C5.6428 13.7703 5.27232 13.8194 4.90022 13.8191C4.62997 13.8191 4.36771 13.7942 4.11279 13.7453C4.64531 15.4065 6.18886 16.6159 8.0196 16.6491C6.53813 17.8118 4.70869 18.4426 2.82543 18.4399C2.49212 18.4402 2.15909 18.4205 1.82812 18.3811C3.74004 19.6102 5.96552 20.2625 8.23842 20.2601C15.9316 20.2601 20.138 13.8875 20.138 8.36111C20.138 8.1803 20.1336 7.99886 20.1256 7.81997C20.9443 7.22845 21.651 6.49567 22.2125 5.65605Z"></path></svg>
                                            <svg title='Copy link' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M13.5759 17.2714L8.46576 14.484C7.83312 15.112 6.96187 15.5 6 15.5C4.067 15.5 2.5 13.933 2.5 12C2.5 10.067 4.067 8.5 6 8.5C6.96181 8.5 7.83301 8.88796 8.46564 9.51593L13.5759 6.72855C13.5262 6.49354 13.5 6.24983 13.5 6C13.5 4.067 15.067 2.5 17 2.5C18.933 2.5 20.5 4.067 20.5 6C20.5 7.933 18.933 9.5 17 9.5C16.0381 9.5 15.1669 9.11201 14.5343 8.48399L9.42404 11.2713C9.47382 11.5064 9.5 11.7501 9.5 12C9.5 12.2498 9.47383 12.4935 9.42408 12.7285L14.5343 15.516C15.167 14.888 16.0382 14.5 17 14.5C18.933 14.5 20.5 16.067 20.5 18C20.5 19.933 18.933 21.5 17 21.5C15.067 21.5 13.5 19.933 13.5 18C13.5 17.7502 13.5262 17.5064 13.5759 17.2714Z"></path></svg>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='Product__Details'>
                                <div>
                                    <ol>
                                        ...
                                        <li>Dimension (L x l x h): <strong>44.5 x 39 x 143 cm</strong></li>
                                        <li>Capacity: <strong>3 Litres Puissance 90 Watts</strong></li>
                                        <li>Volts: <strong>240 Volts</strong></li>
                                        <li>Material: <strong>Plastic</strong></li>
                                        <li>Speed Number <strong>3</strong></li>
                                        <li>Caracteristic: <strong>Vitesse élevée, Oscillation</strong></li>
                                    </ol>
                                </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td key="">Weight</td>
                                            <td key=""><strong>7.00 Kg</strong></td>
                                        </tr>
                                    
                                        <tr>
                                            <td key="">Mark</td>
                                            <td key=""><strong>Bricom</strong></td>
                                        </tr>

                                        <tr>
                                            <td key="">Color</td>
                                            <td key=""><strong>Black</strong></td>
                                        </tr>

                                        <tr>
                                            <td key="">Dimmension</td>
                                            <td key=""><strong>44.5 x 39 x 143 cm</strong></td>
                                        </tr>

                                        <tr>
                                            <td key="">Power</td>
                                            <td key=""><strong>90 W</strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
